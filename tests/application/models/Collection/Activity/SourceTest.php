...
extends PHPUnit_Framework_TestCase
{
     ...
     *
     * @param MaitreCorbeaux_Model_Activity_Source $model1
     * @param MaitreCorbeaux_Model_Activity_Source $model2
     * @param MaitreCorbeaux_Model_Activity_Source $model3
     * @return void
     */
    ...
    public function testRemoveUnexistentElementFromCollection()
    {
        ...
        $model = new MaitreCorbeaux_Model_Activity_Source();
    ...
    public function testMergeTwoCollections($model1, $model2, $model3)
    {
        ...
        $otherCollection = new MaitreCorbeaux_Model_Collection_Activity_Source();
